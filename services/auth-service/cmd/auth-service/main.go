...
func main() {
	...
	r.Post("/v1/session/exchange", func(w http.ResponseWriter, _ *http.Request) {
		httpx.JSON(w, http.StatusAccepted, map[string]any{"issuer": "firebase-auth", "status": "accepted"})
	})
